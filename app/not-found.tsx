  ...
  return (
    <main className="flex flex-col min-h-screen w-full max-w-3xl mx-auto items-center justify-start py-16 px-8 md:py-32 md:px-16 bg-background md:items-start">
      ...
      <div className="flex flex-col md:flex-row my-10">
        <Button className="md:mx-2 my-2 md:my-0" onClick={() => router.back()}>
          <Undo2Icon /> 이전 페이지로 돌아가기
        </Button>
        <Button variant="secondary" className="md:mx-2 my-2 md:my-0" asChild>
          <Link href="/">
            <HomeIcon />
            홈으로 돌아가기
          </Link>
        </Button>
        <Button variant="ghost" className="md:mx-2 my-2 md:my-0" asChild>
