...
export type RatingHistory = {
  ...
  /**
   * The previous rating of the participant exactly before the entry. Optional only if the entry is the first entry of the participant, in which case there is no previous rating to compare to.
   */
